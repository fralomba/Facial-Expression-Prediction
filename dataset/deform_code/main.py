...
for i in range(0, n_examples):
    ...
    def_v4 = def_neutral_v + pred_vector * alpha

    def_v2 = def_neutral_v + regr_lin.predict(def_neutral_v.reshape(1, -1)) * alpha

    def_v3 = def_neutral_v + regr_svr_sig.predict(def_neutral_v.reshape(1, -1)) * alpha

    eng.deform_and_visualize(matlab.double(def_neutral_v.tolist()), matlab.double(def_v4.tolist()),
                             matlab.double(def_v2.tolist()), matlab.double(def_v3.tolist()),
